...
set<string> findsuperkey(int n, vector<pair<string, string>> &vp) {
    set<string> res;
...
int main() {
    ...
    set<string> super = findsuperkey(n,vp);
    ...
    for(auto it: vp){
        ...
        bool f3 = 1;
        if(super.find(it.first) == super.end()) f3 = 0;
        if(f == 0 || (f1 == 0 && f2 == 0) || f3 == 0){
